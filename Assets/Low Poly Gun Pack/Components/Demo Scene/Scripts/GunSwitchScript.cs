...
public class GunSwitchScript : MonoBehaviour {
	...
	public string gun6Text;
	public string gun7Text;
	public string gun8Text;
	public string gun9Text;
	public string gun10Text;
	public string gun11Text;
	public string gun12Text;
	...
	void Start () {
		...
		currentGun = PlayerPrefs.GetInt ("GunSelected");
		//Start with the first gun selected
		currentGunObject = guns[currentGun];
		...
		totalAmmoText.text = guns[0].GetComponent
			<ArmControllerScript>().ShootSettings.magAmmo.ToString();
	...
	void Update () {
		...
		//If key 6 is pressed, and noSwitch is false in GunScript.cs
		if(Input.GetKeyDown(KeyCode.Alpha6) && 
			currentGunObject.GetComponent<ArmControllerScript>().noSwitch == false) {

			changeGun(5);
			totalAmmoText.text = guns[5].GetComponent
				<ArmControllerScript>().ShootSettings.ammo.ToString();
			//Set the currentGunObject to the current gun
			currentGunObject = guns[5];
			//Set the current gun text
			currentGunText.text = gun6Text;
		}

		//If key 7 is pressed, and noSwitch is false in GunScript.cs
		if(Input.GetKeyDown(KeyCode.Alpha7) && 
			currentGunObject.GetComponent<ArmControllerScript>().noSwitch == false) {

			changeGun(6);
			totalAmmoText.text = guns[6].GetComponent
				<ArmControllerScript>().ShootSettings.ammo.ToString();
			//Set the currentGunObject to the current gun
			currentGunObject = guns[6];
			//Set the current gun text
			currentGunText.text = gun7Text;
		}

		//If key 8 is pressed, and noSwitch is false in GunScript.cs
		if(Input.GetKeyDown(KeyCode.Alpha8) && 
			currentGunObject.GetComponent<ArmControllerScript>().noSwitch == false) {

			changeGun(7);
			totalAmmoText.text = guns[7].GetComponent
				<ArmControllerScript>().ShootSettings.ammo.ToString();
			//Set the currentGunObject to the current gun
			currentGunObject = guns[7];
			//Set the current gun text
			currentGunText.text = gun8Text;
		}
		...
		if(Input.GetKeyDown(KeyCode.Alpha9) && 
			...
			changeGun(8);
			totalAmmoText.text = guns[8].GetComponent
				<ArmControllerScript>().ShootSettings.ammo.ToString();
			//Set the currentGunObject to the current gun
			currentGunObject = guns[8];
			//Set the current gun text
			currentGunText.text = gun9Text;
		}
		...
		if(Input.GetKeyDown(KeyCode.Alpha0) && 
			...
			changeGun(9);
			totalAmmoText.text = guns[9].GetComponent
				<ArmControllerScript>().ShootSettings.ammo.ToString();
			//Set the currentGunObject to the current gun
			currentGunObject = guns[9];
			//Set the current gun text
			currentGunText.text = gun10Text;
		}
		...
		if(Input.GetKeyDown(KeyCode.H) && 
			...
			changeGun(10);
			totalAmmoText.text = guns[10].GetComponent
				<ArmControllerScript>().ShootSettings.ammo.ToString();
			//Set the currentGunObject to the current gun
			currentGunObject = guns[10];
			//Set the current gun text
			currentGunText.text = gun11Text;
		}
		...
		if(Input.GetKeyDown(KeyCode.G) && 
			...
			changeGun(11);
			totalAmmoText.text = guns[11].GetComponent
				<ArmControllerScript>().ShootSettings.ammo.ToString();
			//Set the currentGunObject to the current gun
			currentGunObject = guns[11];
			//Set the current gun text
			currentGunText.text = gun12Text;
		}
